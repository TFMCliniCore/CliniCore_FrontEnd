...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* ── Left panel: branding ── */}
      <aside
        className="hidden lg:flex w-[420px] xl:w-[480px] flex-shrink-0 flex-col justify-between p-10
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-300 text-sm leading-relaxed max-w-xs mb-8">
            Administra sucursales, inventario, pacientes y telemedicina desde
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #0e314d, #10a8a8)",
              }}
            >
              <Stethoscope className="text-white" size={20} />
            </div>
            <span className="text-lg font-black tracking-widest uppercase text-gray-800">
              Clinicore
            </span>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/60 border border-gray-100 p-8 md:p-10">
            <div className="mb-8">
              ...
              <p className="text-gray-500 text-sm">
                Accede a tu cuenta de Clinicore
              </p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5" noValidate>
              ...
              <button
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #0e314d 0%, #008585 50%, #105174 100%)",
                }}
              >
                {loading ? (
                  <>
