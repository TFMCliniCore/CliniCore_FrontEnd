    ...
    <>
      ...
      >
        ...
        <div className="pt-10 pb-8 flex flex-col items-center relative z-10 px-4">
          ...
          <p className="text-[11px] text-cyan-300 font-bold tracking-[0.35em] mt-1 uppercase">
            Sistema Veterinario
          </p>
