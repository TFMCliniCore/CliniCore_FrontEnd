...
// 1. Actualizamos la estructura de navItems para incluir subItems
const navItems = [
...
export default function Sidebar() {
  ...
  const Bubbles = () => (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
       {/* (Mantén tu componente Bubbles igual que antes) */}
    ...
    <>
      ...
      >
        ...
        <div className="pt-10 pb-8 flex flex-col items-center relative z-10 px-4">
            ...
            <h1 className="mt-6 text-2xl font-black tracking-[0.3em] uppercase bg-clip-text text-transparent bg-gradient-to-r from-white via-cyan-100 to-white/70">Clinicore</h1>
              ...
              <div key={index} className="space-y-1">
                ...
                >
                  ...
                  >
                    ...
                    {item.submenu && (
                      <ChevronRight
                        size={15}
                        className={`transition-transform duration-300 ${isExpanded ? "rotate-90" : "opacity-40"}`}
                      />
                    )}
                  </Link>
                </div>
                ...
                {item.submenu && item.subItems && (
                  <div className={`
                    ...
                    ${isExpanded ? "max-h-60 opacity-100 mt-1 mb-2" : "max-h-0 opacity-0"}
                  `}>
                      ...
                      {item.subItems.map((sub, subIndex) => {
                        ...
                        return (
                          <Link
                            ...
                            href={sub.href}
                            className={`
                              flex items-center space-x-3 px-6 py-2 rounded-xl text-sm transition-all
                              ${isSubActive 
